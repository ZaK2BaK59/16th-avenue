      ...
      <div className={styles.blockReverse}>
        ...
        <div className={styles.text}>
          <div className={styles.item}>
            ...
            <p>
              Grâce à notre réseau et à notre connaissance du marché, nous vous offrons un accès
              privilégié aux meilleures opportunités.
            </p>
          </div>
          <div className={styles.item}>
            <h3>Valorisation Et Stratégie Performante</h3>
            <p>
              Nous mettons en valeur votre bien avec des techniques éprouvées : storytelling immobilier,
              photographie professionnelle et diffusion stratégique optimisée.
            </p>
          </div>
          <div className={styles.item}>
